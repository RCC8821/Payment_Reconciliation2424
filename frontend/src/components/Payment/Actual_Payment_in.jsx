            ...
            <tbody className="divide-y divide-gray-800/50 bg-gray-900/10">
              {pendingPayments.map((row) => (
                ...
                >
                  ...
                  <td className="px-5 py-4 text-gray-200 max-w-xs truncate" title={row.SiteName}>
                    {row.SiteName || "-"}
                  </td>
                  <td className="px-5 py-4 text-emerald-400 font-medium">
                    {row.Amount || "-"}
                  </td>
                  <td className="px-5 py-4 text-gray-300">{row.CGST || "-"}</td>
                  <td className="px-5 py-4 text-gray-300">{row.SGST || "-"}</td>
                  <td className="px-5 py-4">
                    <span className="inline-block px-3 py-1 text-sm font-medium bg-emerald-900/40 text-emerald-300 rounded border border-emerald-700/40">
                      {row.NetAmount || "-"}
                    </span>
                  </td>
                  <td className="px-5 py-4 text-gray-200 max-w-xs truncate" title={row.RccCreditAccountName}>
                    {row.RccCreditAccountName || "-"}
                  </td>
                  <td className="px-5 py-4">
                  ...
                  <td className="px-5 py-4 text-gray-300 font-mono">{row.ChequeNo || "-"}</td>
                  <td className="px-5 py-4 text-gray-300">{row.ChequeDate || "-"}</td>
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-gradient-to-b from-gray-900 to-black rounded-2xl shadow-2xl w-full max-w-lg border border-indigo-700/40 overflow-hidden">
            <div className="bg-gradient-to-r from-indigo-950 to-purple-950 p-5 flex justify-between items-center border-b border-indigo-700/50">
              <h3 className="text-xl font-bold text-white">Update Actual Bank In</h3>
              <button
                onClick={closeModal}
            ...
            <div className="p-6 space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="bg-gray-800/60 p-4 rounded-xl border border-gray-700/50">
                  <p className="text-xs text-gray-400 uppercase mb-1">Net Amount</p>
                  <p className="text-lg font-bold text-emerald-400">{selectedRow.NetAmount}</p>
                </div>
              </div>
