...
//   // Payment Pages
//   const paymentPages = [
//     { id: "Reconciliation", name: "Reconciliation", allowedEmails: ["varsharccinfra@gmail.com"] },
//     { id: "Form", name: "Forms" },
//     { id: "Actual_Payment_in", name: "Actual Payment In" },
//     { id: "Transfer_bank_To_bank", name: "Transfer Bank to Bank" },
//   ];

//   // RCC Office Pages - Updated with BillEntry and ExpensesPayemnt
//   const rccOfficePages = [
//     { id: "Approvel_By_Mayaksir", name: "Approval By Mayanksir", email: "rccinfra2024@gmail.com" },
//     // Bill Entry - Add emails that should have access
//     { id: "BillEntry", name: "Bill Entry", email: "Govindrcc@gmail.com" },
//     { id: "BillEntry", name: "Bill Entry", email: "varsharccinfra@gmail.com" },
//     { id: "BillEntry", name: "Bill Entry", email: "sandeeppatil1450@gmail.com" },
//     // Expenses Payment - Add emails that should have access
//     { id: "ExpensesPayemnt", name: "Expenses Payment", email: "Govindrcc@gmail.com" },
//     { id: "ExpensesPayemnt", name: "Expenses Payment", email: "varsharccinfra@gmail.com" },
//     // { id: "ExpensesPayemnt", name: "Expenses Payment", email: "sandeeppatil1450@gmail.com" },
//   ];
...
//         return pages.filter((p) => p.id === "BillEntry" || p.id === "ExpensesPayemnt");
//       }
//       return pages;
//     }
...
//           page.allowedEmails?.map((e) => e.toLowerCase()).includes(userEmail.toLowerCase())
//         );
//       }
...
//     if (userEmail.toLowerCase() === specialUserEmail) {
//       if (filteredRccPages.some((p) => p.id === "BillEntry")) {
//         selectSection("rcc", "BillEntry");
//         return;
//       }
//     }
...
//   // Active Component resolution - Updated with BillEntry and ExpensesPayemnt
...
//               <div
//                 className={`p-4 sm:p-5 border-t ${isDarkMode ? "border-white/10" : "border-gray-200"}`}
//               >
//                 <button
//                   onClick={handleLogout}
