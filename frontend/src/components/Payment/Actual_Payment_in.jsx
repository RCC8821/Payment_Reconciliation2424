...
//           <p className="text-xl font-medium text-indigo-300">Loading pending entries...</p>
//         </div>
//       </div>
//     );
//   }
...
//           <p className="text-gray-300 mb-6">Unable to fetch pending actual bank entries.</p>
//           <button 
//             onClick={refetch}
...
//       <div className="min-h-screen bg-gradient-to-br from-black via-indigo-950 to-purple-950 flex items-center justify-center p-6">
//         <div className="text-center max-w-md">
//           <h2 className="text-3xl font-bold text-indigo-300 mb-4">No Pending Entries</h2>
//           <p className="text-gray-400 mb-8">All planned payments have actual status filled.</p>
//           <button 
//             onClick={refetch}
...
//                     </span>
//                   </td>
//                   <td className="px-4 py-5 lg:px-6 lg:py-6 text-gray-200 max-w-xs lg:max-w-md truncate" title={row.SiteName}>
//                     {row.SiteName || "-"}
//                   </td>
//                   <td className="px-4 py-5 lg:px-6 lg:py-6 text-emerald-400 font-medium text-base lg:text-lg">
//                     {row.Amount || "-"}
//                   </td>
//                   <td className="px-4 py-5 lg:px-6 lg:py-6 text-gray-300 text-base">{row.CGST || "-"}</td>
//                   <td className="px-4 py-5 lg:px-6 lg:py-6 text-gray-300 text-base">{row.SGST || "-"}</td>
//                   <td className="px-4 py-5 lg:px-6 lg:py-6">
//                     <span className="inline-block px-4 py-1.5 text-sm lg:text-base font-medium bg-emerald-900/40 text-emerald-300 rounded border border-emerald-700/40">
//                       {row.NetAmount || "-"}
//                     </span>
//                   </td>
//                   <td className="px-4 py-5 lg:px-6 lg:py-6 text-gray-200 max-w-xs lg:max-w-md truncate" title={row.RccCreditAccountName}>
...
//                     </span>
//                   </td>
//                   <td className="px-4 py-5 lg:px-6 lg:py-6 text-gray-300 font-mono text-base">{row.ChequeNo || "-"}</td>
//                   <td className="px-4 py-5 lg:px-6 lg:py-6 text-gray-300 text-base">{row.ChequeDate || "-"}</td>
...
//                         className="inline-flex items-center justify-center p-3 bg-cyan-900/40 text-cyan-300 rounded-lg hover:bg-cyan-800/60 transition hover:scale-105"
//                         title="View Photo"
//                       >
...
//               <h3 className="text-2xl lg:text-3xl font-bold text-white">Update Actual Bank In</h3>
//               <button
//                 onClick={closeModal}
...
//                 </div>
//                 <div className="bg-gray-800/60 p-5 lg:p-6 rounded-xl border border-gray-700/50">
//                   <p className="text-sm lg:text-base text-gray-400 uppercase mb-2">Net Amount</p>
//                   <p className="text-2xl lg:text-3xl font-bold text-emerald-400">{selectedRow.NetAmount}</p>
//                 </div>
//               </div>
          ...
          <table className="w-full min-w-[1400px] border-collapse">
            ...
            <tbody className={`divide-y ${
              ...
              {pendingPayments.map((row) => (
                ...
                >
                  <td className="px-4 py-5 lg:px-6 lg:py-6">
                    <span className={`inline-block px-3 py-1.5 text-xs lg:text-sm rounded font-medium border ${
                      isDarkMode 
                  ...
                  <td className={`px-4 py-5 lg:px-6 lg:py-6 max-w-xs lg:max-w-md truncate ${isDarkMode ? 'text-gray-200' : 'text-gray-800'}`} title={row.SiteName}>
                    {row.SiteName || "-"}
                  </td>
                  <td className={`px-4 py-5 lg:px-6 lg:py-6 font-medium text-base lg:text-lg ${isDarkMode ? 'text-emerald-400' : 'text-emerald-600'}`}>
                    {row.Amount || "-"}
                  </td>
                  <td className={`px-4 py-5 lg:px-6 lg:py-6 text-base ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>{row.CGST || "-"}</td>
                  <td className={`px-4 py-5 lg:px-6 lg:py-6 text-base ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>{row.SGST || "-"}</td>
                  <td className="px-4 py-5 lg:px-6 lg:py-6">
                    <span className={`inline-block px-4 py-1.5 text-sm lg:text-base font-medium rounded border ${
                      isDarkMode 
                  ...
                  <td className={`px-4 py-5 lg:px-6 lg:py-6 max-w-xs lg:max-w-md truncate ${isDarkMode ? 'text-gray-200' : 'text-gray-800'}`} title={row.RccCreditAccountName}>
                    {row.RccCreditAccountName || "-"}
                  </td>
                  <td className="px-4 py-5 lg:px-6 lg:py-6">
                    <span className={`inline-block px-3 py-1.5 text-xs lg:text-sm rounded border ${
                      isDarkMode 
                  ...
                  <td className={`px-4 py-5 lg:px-6 lg:py-6 font-mono text-base ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                    {row.ChequeNo || "-"}
                  </td>
                    ...
                    {row.ChequePhoto ? (
                      <a
                        ...
                        className={`inline-flex items-center justify-center p-3 rounded-lg hover:scale-105 transition ${
                          isDarkMode ? 'bg-cyan-900/40 text-cyan-300 hover:bg-cyan-800/60' : 'bg-cyan-100 text-cyan-700 hover:bg-cyan-200'
                        }`}
                        title="View Photo"
                      >
                        <Eye className="w-6 h-6" />
                      ...
                      <span className={`${isDarkMode ? 'text-gray-500' : 'text-gray-400'} text-xl`}>—</span>
                    )}
                  </td>
                  <td className="px-4 py-5 lg:px-6 lg:py-6 text-center">
                    <span className={`inline-block px-3 py-1.5 text-xs lg:text-sm rounded border ${
            ...
            <div className="p-6 lg:p-10 space-y-8">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 lg:gap-8">
                ...
                <div className={`p-5 lg:p-6 rounded-xl border ${
                  ...
                  <p className={`text-sm lg:text-base uppercase mb-2 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Net Amount</p>
