...
// import { X, Building, Search, FileText, Wallet } from "lucide-react";
...
//     const banks = reconciliationData
//       .map((item) => item.bankDetails)
//       .filter(Boolean);
...
//   const { data: modalBankData, isLoading: isModalBankLoading } =
...
//     }, 0);
//     const currentE3 = Number(
//       mainBankData?.bankClosingBalance?.replace(/,/g, "") || 0
//     );
//     return {
//       totalPaid,
...
//         data = data.filter(
//           (item) =>
//             (item.contractorName?.toLowerCase() || "").includes(
...
//       setFilteredData([]);
//     }
//   }, [selectedBank, searchTerm, reconciliationData]);
...
//   useEffect(() => {
//     if (isModalOpen && selectedItem && modalBankData?.success) {
//       const originalBalance = Number(
//         modalBankData.bankClosingBalance.replace(/,/g, "")
//       );
...
//       setEditForm((prev) => ({
//         ...prev,
//         BANK_CLOSING_BALANCE: `₹${remaining}`,
//       }));
//     }
...
//       bankClosingBalanceAfterPayment: editForm.BANK_CLOSING_BALANCE.replace(
//         "₹",
//         ""
//       ).trim(),
...
//   return (
//     // FIX 1: max-w-full and overflow-x-hidden on the main wrapper
...
//               Total All Bank Amount
//             </p>
//             <p className="text-xl font-black">
//               ₹{totalGlobalAmount.toLocaleString("en-IN")}
//             </p>
//           </div>
...
//             {/* FIX 2: Added break-words to handle long Bank Names */}
//             <div className="bg-amber-50 p-4 rounded-xl border border-amber-100 max-w-full">
...
//                     {isMainBankLoading
//                       ? "..."
//                       : `₹${mainBankData?.bankClosingBalance}`}
//                   </p>
//                 </div>
//                 <div className="bg-white p-3 rounded-lg border border-yellow-100">
//                   <p className="text-[9px] font-bold text-yellow-600 uppercase">
//                     Pending
//                   </p>
//                   <p className="text-sm font-black text-gray-800">
//                     {bankSpecificStats.count}
//                   </p>
//                 </div>
...
//                   <p className="text-[9px] font-bold text-green-100 uppercase">
//                     Final Bal.
//                   </p>
...
//               <input
//                 type="text"
//                 className="w-full p-2.5 pl-10 bg-white border rounded-xl text-sm outline-none focus:ring-1 focus:ring-blue-500"
//                 placeholder="Search..."
//                 value={searchTerm}
...
//             {/* FIX 3: Robust Table Overflow Container */}
//            <div className="bg-white rounded-xl shadow-sm border border-gray-200 w-full overflow-hidden">
//   {/* Horizontal scroll container ko hataya kyuki ab zarurat nahi */}
//   <div className="w-full">
//     <table className="w-full text-left border-collapse">
//       {/* min-w-[1000px] PURI TARAH HATAYA - yeh hi scroll ki main wajah thi */}
...
//               {item.contractorName}
//             </td>
//             <td className="px-3 py-3 text-[11px] font-black text-blue-600">
//               ₹{item.paidAmount}
//             </td>

//             {/* BANK COLUMN - FULL VISIBLE WITHOUT SCROLL */}
...
//               {item.paymentMode}
//             </td>
//             <td className="px-3 py-3 text-[11px] break-words max-w-xs">
//               {item.paymentDetails}
//             </td>
//             <td className="px-3 py-3 text-[11px] whitespace-nowrap">
//               {item.paymentDate}
...
//           </div>
//         ) : (
//           <div className="bg-white border-2 border-dashed rounded-xl p-12 text-center text-gray-400 font-bold text-sm">
//             Select a bank to view data.
//           </div>
//         )}
//       </div>

//       {/* Modal - Fixed for Small Screens */}
...
//                   <p className="text-[8px] text-green-600 uppercase font-bold">
//                     E3 Bal.
//                   </p>
...
//                   <p className="text-[8px] text-red-600 uppercase font-bold">
//                     Paid
//                   </p>
