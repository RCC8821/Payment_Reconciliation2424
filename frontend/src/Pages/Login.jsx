...
import { useNavigate } from "react-router-dom";
import { LogIn, Sparkles, Zap, FileText } from "lucide-react"; // ✅ FileText icon added
...
const Login = () => {
  ...
  // ✅ Office Expenses Form button handler
  const handleOfficeExpensesClick = () => {
    navigate("/OfficeForm");
  };
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-black/30 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20 transform transition-all">
          ...
          <div className="mt-6 flex items-center gap-3">
            ...
            <span className="text-xs text-blue-300/60">OR</span>
            <div className="flex-1 h-px bg-white/20"></div>
          </div>

          {/* ✅ Office Expenses Form Button - Login button ke neeche */}
          <div className="mt-4">
            <button
              type="button"
              onClick={handleOfficeExpensesClick}
              className="w-full py-3 px-4 bg-gradient-to-r from-emerald-600 to-teal-700 hover:from-emerald-700 hover:to-teal-800 text-white font-semibold rounded-xl shadow-lg transform transition-all hover:scale-105 flex items-center justify-center gap-2"
            >
          ...
          {/* ✅ Divider line for clean separation */}
