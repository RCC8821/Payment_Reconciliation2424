...
//     return processedTransactions.filter((t) => t.date >= startDate);
//   }, [period, processedTransactions, currentDate]);

//   const totalIn = useMemo(() => {
//     if (period === "all") return apiTotalIn;
//     return filteredData
//       .filter((t) => t.type === "in")
//       .reduce((sum, t) => sum + t.amount, 0);
//   }, [filteredData, period, apiTotalIn]);

//   const totalOut = useMemo(() => {
//     if (period === "all") return apiTotalOut;
//     return filteredData
//       .filter((t) => t.type === "out")
//       .reduce((sum, t) => sum + t.amount, 0);
//   }, [filteredData, period, apiTotalOut]);

//   const balance = useMemo(() => {
//     if (period === "all") return apiNetBalance;
//     return totalIn - totalOut;
//   }, [totalIn, totalOut, period, apiNetBalance]);
...
//           ? "bg-gradient-to-br from-black via-indigo-950 to-purple-950" 
//           : "bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50"}`}>
//         <div className={`backdrop-blur-xl rounded-2xl border p-8 max-w-md text-center
//           ${isDarkMode 
...
//   const hasNoTransactionsInPeriod = filteredData.length === 0 && period !== "all";

//   return (
//     <div className={`
//       min-h-screen relative overflow-hidden py-8 px-4 sm:px-6 lg:px-8 xl:px-10 w-full
//       ${isDarkMode 
//         ? "bg-gradient-to-br from-black via-indigo-950 to-purple-950" 
//         : "bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50"}
//     `}>
...
//         <div className={`absolute -top-20 -left-20 w-[500px] h-[500px] rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-pulse-slow
//           ${isDarkMode ? "bg-purple-700" : "bg-purple-300/40"}`}></div>
//         <div
//           className={`absolute top-1/4 right-0 w-[600px] h-[600px] rounded-full mix-blend-multiply filter blur-3xl opacity-25 animate-pulse-slow
//             ${isDarkMode ? "bg-blue-700" : "bg-blue-300/40"}`}
//           style={{ animationDelay: "3s" }}
//         ></div>
//         <div
//           className={`absolute -bottom-32 left-1/3 w-[450px] h-[450px] rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-pulse-slow
...
//         {/* Header */}
//         <div className={`backdrop-blur-xl rounded-2xl border shadow-2xl w-full p-6 sm:p-8 lg:p-10 xl:p-12
//           ${isDarkMode 
//             ? "bg-black/40 border-indigo-700/40" 
//             : "bg-white/70 border-indigo-200/60"}`}>
...
//               <button
//                 onClick={() => refetch()}
//                 className={`px-4 py-2.5 backdrop-blur-md border rounded-xl text-white hover:bg-white/10 transition-all flex items-center gap-2 justify-center
//                   ${isDarkMode 
//                     ? "bg-black/50 border-indigo-600/50 hover:bg-white/10" 
//                     : "bg-white/60 border-indigo-300/60 hover:bg-gray-100 text-gray-800"}`}
//                 title="Refresh data"
//               >
//                 <RefreshCw className="w-4 h-4" />
//               </button>

//               <div className={`backdrop-blur-md border p-1.5 rounded-xl shadow-lg flex flex-wrap
//                 ${isDarkMode 
//                   ? "bg-black/50 border-indigo-600/50" 
//                   : "bg-white/60 border-indigo-300/60"}`}>
...
//               : "bg-yellow-50/70 border-yellow-300/60"}`}>
//             <p className={`text-lg ${isDarkMode ? "text-yellow-300" : "text-yellow-800"}`}>
//               No transactions found for the selected period ({period.toUpperCase()})
//             </p>
//             <button
...
//             {/* Bar Chart */}
//             <div className={`lg:col-span-2 backdrop-blur-xl rounded-2xl border shadow-2xl p-6 md:p-8 lg:p-10 w-full
//               ${isDarkMode 
//                 ? "bg-black/30 border-indigo-700/40" 
//                 : "bg-white/70 border-indigo-200/60"}`}>
...
//                 </h3>
//                 <span className={`px-4 py-2 rounded-lg text-sm lg:text-base font-medium
//                   ${isDarkMode 
...
//             {/* Pie Chart */}
//             <div className={`backdrop-blur-xl rounded-2xl border shadow-2xl p-6 md:p-8 lg:p-10 w-full
//               ${isDarkMode 
//                 ? "bg-black/30 border-indigo-700/40" 
//                 : "bg-white/70 border-indigo-200/60"}`}>
...
//                 ${isDarkMode ? "border-indigo-700/30" : "border-indigo-200/30"}`}>
...
//         {filteredData.length > 0 && (
//           <div className={`backdrop-blur-xl rounded-2xl border overflow-hidden shadow-2xl w-full
//             ${isDarkMode 
//               ? "bg-black/30 border-indigo-700/40" 
//               : "bg-white/70 border-indigo-200/60"}`}>
...
//                 </h3>
//                 <span className={`px-5 py-2 rounded-lg text-sm lg:text-base font-medium
//                   ${isDarkMode 
//                     ? "bg-indigo-900/50 text-indigo-300" 
//                     : "bg-indigo-100/70 text-indigo-700"}`}>
...
//                   ${isDarkMode ? "bg-black/50" : "bg-gray-100/80"}`}>
//                   <tr>
//                     <th className={`px-6 py-4 text-sm lg:text-base font-semibold uppercase tracking-wider
//                       ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>Date</th>
//                     <th className={`px-6 py-4 text-sm lg:text-base font-semibold uppercase tracking-wider
//                       ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>Site/Vendor</th>
//                     <th className={`px-6 py-4 text-sm lg:text-base font-semibold uppercase tracking-wider
//                       ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>Category</th>
//                     <th className={`px-6 py-4 text-sm lg:text-base font-semibold uppercase tracking-wider
//                       ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>Type</th>
//                     <th className={`px-6 py-4 text-sm lg:text-base font-semibold uppercase tracking-wider text-right
...
//                     <tr
//                       key={`transaction-${i}`}
//                       className={`hover:bg-opacity-30 transition-colors duration-150
...
//                         {t.siteName || t.vendorName || "-"}
//                       </td>
//                       <td className="px-6 py-5">
//                         <span className={`px-3 py-1.5 rounded-lg text-sm lg:text-base font-medium
//                           ${isDarkMode ? "bg-gray-800/70 text-gray-200" : "bg-gray-200/70 text-gray-800"}`}>
//                           {t.category}
//                         </span>
//                       </td>
//                       <td className="px-6 py-5">
...
//                       </td>
//                       <td
//                         className={`px-6 py-5 text-right text-lg lg:text-xl font-bold
...
//               <div className={`p-6 lg:p-8 border-t text-center
//                 ${isDarkMode ? "bg-black/40 border-indigo-700/30" : "bg-gray-50/70 border-indigo-200/30"}`}>
...
// const StatCard = ({ title, amount, color, icon, isBalance = false, isDarkMode }) => {
//   const colorMap = {
//     emerald: {
//       bg: isDarkMode 
...
//       light: isDarkMode ? "bg-emerald-950/30" : "bg-emerald-50/40",
//       titleText: isDarkMode ? "text-gray-400" : "text-gray-600",
//     },
//     rose: {
//       bg: isDarkMode 
//         ? "bg-gradient-to-br from-rose-900/60 to-pink-900/60" 
//         : "bg-gradient-to-br from-rose-50/80 to-pink-50/80",
//       text: isDarkMode ? "text-rose-300" : "text-rose-800",
//       border: isDarkMode ? "border-rose-700/40" : "border-rose-200/60",
//       light: isDarkMode ? "bg-rose-950/30" : "bg-rose-50/40",
//       titleText: isDarkMode ? "text-gray-400" : "text-gray-600",
//     },
//   };
...
//   return (
//     <div
//       className={`backdrop-blur-xl rounded-2xl border shadow-2xl hover:shadow-3xl transition-all duration-300 relative overflow-hidden w-full p-6 lg:p-8
//         ${isDarkMode 
...
//     }
//     if (filters.expHead && filters.expHead !== "All") {
//       data = data.filter((t) => t.category === filters.expHead);
//     }

//     return {
//       siteNames: ["All", ...new Set(data.map((t) => t.siteName || "").filter(Boolean))].sort(),
//       bankNames: ["All", ...new Set(data.map((t) => t.bankName || "").filter(Boolean))].sort(),
//       expHeads: ["All", ...new Set(data.map((t) => t.category || "").filter(Boolean))].sort(),
//     };
//   }, [processedTransactions, filters.siteName, filters.bankName, filters.expHead]);
...
//       >
//         <div
//           className={`backdrop-blur-xl rounded-2xl border p-8 max-w-md text-center
//           ${isDarkMode ? "bg-red-900/30 border-red-700/40" : "bg-red-50/80 border-red-200"}`}
//         >
...
//         <div
//           className={`backdrop-blur-xl rounded-2xl border p-8 max-w-md text-center
//           ${isDarkMode ? "bg-indigo-900/30 border-indigo-700/40" : "bg-indigo-50/70 border-indigo-200"}`}
//         >
//           <Wallet className={`w-16 h-16 mx-auto mb-4 ${isDarkMode ? "text-indigo-400" : "text-indigo-600"}`} />
...
//                   ${isDarkMode ? "bg-gray-800/60 border-gray-600 text-white placeholder-gray-400" : "bg-white border-gray-300 text-gray-900 placeholder-gray-500"}`}
//               />
//               <datalist id="siteList">
//                 {uniqueOptions.siteNames.map((opt) => (
//                   <option key={opt} value={opt === "All" ? "" : opt}>
//                     {opt === "All" ? "All Sites" : opt}
//                   </option>
//                 ))}
//               </datalist>
//             </div>
...
//                 {uniqueOptions.bankNames.map((opt) => (
//                   <option key={opt} value={opt === "All" ? "" : opt}>
//                     {opt === "All" ? "All Banks" : opt}
//                   </option>
//                 ))}
//               </datalist>
//             </div>
...
//                 onChange={(e) => setFilters((prev) => ({ ...prev, expHead: e.target.value }))}
//                 placeholder="Type or select head..."
//                 className={`w-full px-4 py-2.5 rounded-lg border focus:outline-none focus:ring-2 focus:ring-indigo-500
//                   ${isDarkMode ? "bg-gray-800/60 border-gray-600 text-white placeholder-gray-400" : "bg-white border-gray-300 text-gray-900 placeholder-gray-500"}`}
//               />
//               <datalist id="expHeadList">
//                 {uniqueOptions.expHeads.map((opt) => (
//                   <option key={opt} value={opt === "All" ? "" : opt}>
//                     {opt === "All" ? "All Heads" : opt}
//                   </option>
//                 ))}
//               </datalist>
//             </div>
...
//             {/* Clear Filters */}
//             {(filters.siteName || filters.bankName || filters.expHead) && (
//               <div className="flex items-end">
//                 <button
//                   onClick={() => setFilters({ siteName: "", bankName: "", expHead: "" })}
//                   className="px-6 py-2.5 bg-gray-600/80 hover:bg-gray-700 text-white rounded-lg transition-colors flex items-center gap-2"
//                 >
...
//                       ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>Date</th>
//                     <th className={`px-6 py-4 text-sm lg:text-base font-semibold uppercase tracking-wider
//                       ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>Site Name</th>
//                     <th className={`px-6 py-4 text-sm lg:text-base font-semibold uppercase tracking-wider
//                       ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>Category</th>
//                     <th className={`px-6 py-4 text-sm lg:text-base font-semibold uppercase tracking-wider
//                       ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>Type</th>
