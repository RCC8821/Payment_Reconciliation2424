...
//         Vendor_Name_4: (row[39] || '').toString().trim(),
//         BILL_NO_4: (row[40] || '').toString().trim(),
//         BILL_DATE_4: (row[41] || '').toString().trim(),
//         BASIC_AMOUNT: (row[42] || '').toString().trim(),
//         CGST_4: (row[43] || '').toString().trim(),
...
//     const updates = [
//       { range: `RCC_OFFICE_FMS!BC${sheetRowNumber}`, values: [[STATUS_5 || '']] },
//       // { range: `RCC_OFFICE_FMS!BE${sheetRowNumber}`, values: [[NET_AMOUNT_5 || '']] },
//       { range: `RCC_OFFICE_FMS!BF${sheetRowNumber}`, values: [[PAID_AMOUNT_5 || '']] },
//       { range: `RCC_OFFICE_FMS!BG${sheetRowNumber}`, values: [[BALANCE_AMOUNT_5 || '']] },
//       { range: `RCC_OFFICE_FMS!BH${sheetRowNumber}`, values: [[BANK_DETAILS_5 || '']] },
//       { range: `RCC_OFFICE_FMS!BI${sheetRowNumber}`, values: [[PAYMENT_MODE_5 || '']] },
//       { range: `RCC_OFFICE_FMS!BJ${sheetRowNumber}`, values: [[PAYMENT_DETAILS_5 || '']] },
//       { range: `RCC_OFFICE_FMS!BK${sheetRowNumber}`, values: [[PAYMENT_DATE_5 || '']] },
//       { range: `RCC_OFFICE_FMS!BL${sheetRowNumber}`, values: [[Remark_5 || '']] },
//     ];
...
// //     const updates = [
// //       {
// //         range: `RCC_OFFICE_FMS!BB${sheetRowNumber}`,
// //         values: [[STATUS_5 || '']],
// //       },
// //       {
// //         range: `RCC_OFFICE_FMS!BD${sheetRowNumber}`,
// //         values: [[NET_AMOUNT_5 || '']],         // NET AMOUNT
// //       },
// //       {
// //         range: `RCC_OFFICE_FMS!BE${sheetRowNumber}`,
// //         values: [[TDS_5 || '']],                // TDS
// //       },
// //      {
