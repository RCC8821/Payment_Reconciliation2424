...
//   useAddPaymentMutation, 
//   useSubmitCapitalMovementMutation,
//   useSubmitBankTransferMutation,  // ← assuming this mutation exists
//   useGetDropdownDataQuery 
// } from '../../features/Payment/FormSlice';
...
//     if (!transferFormData.Transfer_A_C_Name) return alert('From Account is required');
//     if (!transferFormData.Transfer_Received_A_C_Name) return alert('To Account is required');
...
//     if (!transferFormData.PAYMENT_MODE) return alert('Payment Mode is required');

//     if (showTransferTransactionDetails && 
//         (!transferFormData.PAYMENT_DETAILS?.trim() || !transferFormData.PAYMENT_DATE?.trim())) {
//       return alert('Payment Details / UTR and Date are required for selected mode');
//     }
...
//                     {transferData?.UID && (
//                       <p className="mt-4 text-emerald-200 text-lg">
//                         UID: <span className="font-mono bg-emerald-950/70 px-5 py-2 rounded">{transferData.UID}</span>
//                       </p>
//                     )}
//                   </div>
//                 )}
