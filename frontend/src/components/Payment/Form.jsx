...
// const Form = () => {
//   const [addPayment, { isLoading: isSubmitting, isSuccess, isError, error, data }] = useAddPaymentMutation();
...
//       const reader = new FileReader();
//       reader.onloadend = () => {
//         setFormData(prev => ({ ...prev, ChequePhoto: reader.result }));
//       };
//       reader.readAsDataURL(file);
//     }
//   };
...
//   const removePhoto = () => {
//     setFormData(prev => ({ ...prev, ChequePhoto: null }));
//   };

//   const handleSubmit = async () => {
//     if (!formData.SiteName) return alert('Site Name is required');
//     if (!formData.Amount || Number(formData.Amount) <= 0) return alert('Valid Amount is required');
//     if (!formData.RccCreditAccountName) return alert('Please select RCC Credit Account Name');
//     if (showTransactionFields && (!formData.TransactionNo.trim() || !formData.TransactionDate.trim())) {
...
//         ChequeNo: formData.TransactionNo,
//         ChequeDate: formData.TransactionDate,
//         ChequePhoto: formData.ChequePhoto,
//       }).unwrap();
...
//           {/* Header */}
//           <div className="bg-gradient-to-r from-emerald-600 to-teal-600 shadow-lg px-8 py-6">
//             <h2 className="text-3xl font-bold text-white text-center">Client In Form</h2>
//             <p className="text-blue-100 text-center mt-2">Fill in the payment details below</p>
//           </div>

//           <div className="p-8 space-y-6">
//             {/* Site Name / Project Dropdown */}
//             <div className="space-y-2">
//               <label className="block text-sm font-semibold text-gray-700">
...
//             {/* RCC Credit Account Name Dropdown */}
//             <div className="space-y-2">
//               <label className="block text-sm font-semibold text-gray-700">
//                 RCC Credit Account Name <span className="text-red-500">*</span>
//               </label>
//               {isDropdownLoading ? (
//                 <p className="text-gray-500 italic">Loading accounts...</p>
//               ) : isDropdownError ? (
//                 <p className="text-red-600">⚠ Failed to load accounts. Please refresh.</p>
//               ) : accounts.length === 0 ? (
//                 <p className="text-orange-600">No accounts available</p>
//               ) : (
//                 <select
//                   name="RccCreditAccountName"
//                   value={formData.RccCreditAccountName}
...
//                       value={formData.TransactionNo}
//                       onChange={handleChange}
//                       placeholder={formData.PaymentMode === 'Cheque' ? 'Enter cheque number' : 'Enter UTR number'}
//                       className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all"
//                     />
//                   </div>
//                   <div className="space-y-2">
