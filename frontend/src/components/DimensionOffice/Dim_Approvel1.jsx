...
function Dim_Approvel1() {
  ...
  const [updateApproval, { isLoading: isUpdating }] = useUpdateDimOfficeExpenseApprovalMutation();
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <h2 className="text-3xl font-bold text-gray-800">Dimension Office Expenses  Level 1 Approval</h2>
