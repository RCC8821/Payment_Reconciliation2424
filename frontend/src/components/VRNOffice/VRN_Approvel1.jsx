...
//   // Theme ko document pe apply karna + real-time sync
//   useEffect(() => {
//     const applyTheme = () => {
//       const saved = localStorage.getItem("isDarkMode");
...
//     // Dusre tab / window se change hone par suno
...
//     // Safety ke liye har 800ms check (optional lekin reliable banata hai)
...
//   // ── Loading / Error / Empty states (theme ke saath) ────────────────────────────────
//   if (isLoading) {
//     return (
...
//   // ── Main UI (baaki code same, sirf theme classes) ────────────────────────────────
//   return (
              ...
              <div className="overflow-x-auto rounded-xl border">
                <table className="w-full table-auto min-w-max">
                  ...
                  <tbody className={`divide-y ${
                    ...
                    {itemsForSelectedBill.map((item) => {
                      // ── Photo validation logic (same as Approvel_By_Mayaksir) ───────────────
